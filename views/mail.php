...
$posts = json_decode(file_get_contents("db/post.json"));


$json_string = file_get_contents('db/post.json');
...
foreach($posts as $postname=>$n) {
  ...
  <div class="post__header">
    <div class="post__profile">
      <a href="#" class="post__avatar">
        <img src="cdn/' .$data[$postname][0]['author']. '.jpg" alt="User Picture" />
      </a>
      <a href="#" class="post__user">'.$data[$postname][0]['author'].'</a>
    </div>
  ...
  <div class="post__footer">
    ...
    <div class="post__infos" style="padding-top: 15px;">
      

      <div class="post__description">
        <span>
          <a class="post__name--underline" href="#">'.$data[$postname][0]['author'].'</a>
          ' . $postname . '
        </span>
      </div>

      <span class="post__date-time">'.$data[$postname][0]['time']. '</span>
    </div>
